...
scrolledtext.ScrolledText(mighty, width=30, height=3, wrap=tk.WORD).grid(column=0, columnspan=3,row=6 , sticky="WE")
...
chVarDis = tk.IntVar()  
check1 = tk.Checkbutton(mighty2,width=12,text="Disabled" ,variable=chVarDis,state='disabled')
check1.select()  
